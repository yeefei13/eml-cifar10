...
##resnet18
class mNet18(nn.Module):
    def __init__(self, n_classes):
        super(mNet18, self).__init__()
        ...
        self.conv2_1=nn.Sequential(
                        # dw
                        nn.Conv2d(in_channels=64, out_channels=64, kernel_size=3, stride=1, padding=1, groups=32, bias=False),
                        nn.BatchNorm2d(64),
